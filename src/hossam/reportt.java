...
public class reportt extends javax.swing.JFrame {
  Connection con ;  
    ...
    ResultSet rs;
     String dayyy;
    public String rab77,pricee,gomlaa;
         ...
         || dayy == 5 || dayy == 6 || dayy == 7 || dayy == 8 || dayy == 9 )
 {
    ...
    private void initComponents() {
        ...
        jLabel9.setText("الي");
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 30, 50, -1));
        ...
        jPanel1.add(day2, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 80, 60, 30));
        ...
        s5.setText("/");
        jPanel1.add(s5, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 80, 10, -1));

        month2.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jPanel1.add(month2, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 80, 60, 30));
        ...
        s6.setText("/");
        jPanel1.add(s6, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 80, 10, -1));

        year2.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jPanel1.add(year2, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 80, 60, 30));
        ...
        jPanel1.add(save, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 140, 120, 40));

        day.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jPanel1.add(day, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 30, 60, 30));
        ...
        s3.setText("/");
        jPanel1.add(s3, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 30, 10, -1));

        month.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jPanel1.add(month, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 30, 60, 30));
        ...
        s4.setText("/");
        jPanel1.add(s4, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 30, 10, -1));

        year.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jPanel1.add(year, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 30, 60, 30));
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
       String from=year.getText()+"-"+"0"+month.getText()+"-"+day.getText();
    String to=year2.getText()+"-"+"0"+month2.getText()+"-"+day2.getText();
     ...
     InputStream in=null;
      try {
          ...
          String reportpath= "D:\\hossam\\calender.jasper";
