...
Connection con ;
    ...
    public addtype() throws ParseException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 100, 120, 30));

        name.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jPanel1.add(name, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 100, 260, 40));
        ...
        jPanel1.add(save, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 170, 120, 40));
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
         ...
         String namee = name.getText();
            ...
            {
                JOptionPane.showMessageDialog(this, " Please add Type");
            }
            else
            {
                ...
                if(dialogResult == 0) {
                    try{
                        String sql = "INSERT INTO hossam.types (name) VALUES ('"+namee+"')";
                ...
                {JOptionPane.showMessageDialog(this, "Canceld");
