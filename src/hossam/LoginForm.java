...
{
   String x = "D:\\hossam\\data";
        Process pp = null;
       try{
           Runtime runtime = Runtime.getRuntime();
          
           pp=runtime.exec("C:\\Program Files\\MySQL\\MySQL Server 8.0.23\\bin\\mysqldump.exe -uroot -proot --add-drop-database -B hossam -r"+x+".bat");
...
String name = txtname.getText();
        ...
        String q = "SELECT * FROM gym.users where username=? and password=?";
        try {
